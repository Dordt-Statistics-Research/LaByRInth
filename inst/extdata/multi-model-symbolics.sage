...
def parse_probs_to_R(model):
    ...
    print(""                                                                                    )
    print("## This file is auto-generated by multi-model-symbolics.sage for plant in a"         )
    print("## population model of" + model                                                      )
    print("## plants. To generate a similar file for any generation of"              )
    ...
    site_pair_trans_probs = get_site_pair_trans_probs(model)
...
def get_site_pair_trans_probs(model):
    if (model in ["F2","F3","F4","F5","F6","F7","F8"]):
        generation = int(model[1])  # integer value of second character in model string
